(() => {
	...
	const sceneInfo = [
		...
		},
		{
			...
			objs: {
				...
				imagesPath: [
					'dongjoonyang.github.io/images/blend-image-1.jpg',
					'dongjoonyang.github.io/images/blend-image-2.jpg'
				],
				images: []
			},
			values: {
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `dongjoonyang.github.io/video/001/${1 + i}.JPG`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `dongjoonyang.github.io/video/002/IMG_${1000 + i}.JPG`;
